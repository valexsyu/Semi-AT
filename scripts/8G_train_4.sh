...
#          --enable_fsdp --pure_bf16 \
#          --output_dir /work/valex1377/semi_at_llama/llama_model/peft/KD_lora_b3_WoKLDiv_WiSeqloss \
#          --model_name /work/valex1377/semi_at_llama/llama_model/7B-chat \
#          --num_epochs 1 \
...
torchrun --nnodes 1 --nproc_per_node 8 finetuning_kd.py \
         ...
         --enable_fsdp \
         --dist_checkpoint_folder /work/valex1377/semi_at_llama/llama_model/KD_opentext_gen_20k_ft_b3_WoKLDiv_WiSeqloss \

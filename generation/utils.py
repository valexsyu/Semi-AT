...
class GenerationSemiAT(GenerationMixin):
    ...
    def greedy_search_semi_at(
        ...
        **model_kwargs,
        ...
        previous_same_sequences_length = None
        ...
        while True:
            ...
            model_inputs, previous_same_sequences_length = self.prepare_inputs_for_generation(input_ids, insert_token_num, previous_same_sequences_length, **model_kwargs)
